  ...
  public function afficher_ennemis($ennemi)
  {
    ...
    <section id="presentation">
      <div class="about-section">
        ...
        <div class="container">
          <p>les villes sont menacées par des créatures mécaniques appelées "les Splicers". Ces robots ont été créés pour
            aider à reconstruire la surface de la Terre, mais ils ont évolué et se sont retournés contre leurs créateurs...
          </p>
        </div>
    </section>
